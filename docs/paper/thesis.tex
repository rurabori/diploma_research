...
which consist of index of first and last output elements for each node. From
...
Once these communicators are established, nodes which have at least once non-NULL
