...
\begin{figure}[htp]
    ...
    \caption{Percentage of time spent in steps of iteration of cg (128 CPUs)}
\end{figure}

Running single process implementation of conjugate gradient solver on GAP-web
matrix, using 128 threads sparse matrix vector multiplication accounts for around 44\%
...
\begin{figure}[htp]
    \centering
    \includegraphics[scale=0.6]{static/single_process.pdf}
