...
\dirtree{%
    ...
    .2 resources\DTcomment{Auxiliary resources}.
    .3 benchmark\_data\DTcomment{Data from benchmarks ran on RCI cluster}.
    .3 config.yaml\DTcomment{Default config for \texttt{dim\_cli}}.
    .2 docs/paper\DTcomment{the thesis source in \LaTeX format}.
    .2 tests\DTcomment{Unit tests}.
