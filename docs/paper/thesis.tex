...
\begin{tikzpicture}[
    ...
    % r0
    \node[p1node] at (0.25, 1.75) {1};
    \node[p1node] at (1.25, 1.75) {2};

    %r1
    \node[p2node] at (0.75, 1.25) {3};

    %r2
    \node[p2node] at (0.25, 0.75) {4};
    \node[p3node] at (1.25, 0.75) {5};

    %r3
    \node[p3node] at (0.25, 0.25) {6};
    \node[p4node] at (1.25, 0.25) {7};
    \node[p4node] at (1.75, 0.25) {8};

    \node at (2.5, 1) {$* x = $};

    \coordinate (yCoo) at (3, 0.75);

    \draw[step=0.5cm,gray,very thin] (yCoo) grid ($ (yCoo) + (2, 0.5)$);
