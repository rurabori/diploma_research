...
the average throughput was only 65MB/s.  After profiling, it beacame obvious that parsing the string representation 
...
was deployed. With an average throughput of 88.67MB/s it provided about 1.36x speedup but it was still inadequate.
