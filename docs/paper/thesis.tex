...
OpenMP API, used to parallelize the computation. SIMD parallel
processing as well as SSE/AVX instructions sets are defined in Section~\ref{tech:simd}.
...
last thread). Tiles within the context of a thread are then processed sequentially as shown in 
Figure~\ref{csr5:thr_dist}.
