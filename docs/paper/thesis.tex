...
\subsection{Matlab compatible sparse matrix storage}
...
Loading the same matrix used for benchmarking loading times for matrix market exchange format,
HDF5 took 2.854ms which is ~100x speedup.
48\% of time spent in the dataset reading function. 16\% of time spent in \mintinline{C++}{vector::resize}.
